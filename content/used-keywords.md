...
Track primary keywords that have already been used as the focus of a blog post. Never reuse these as a primary keyword.
...
## Secondary Keywords Used (available as primary for future posts)

These were used as secondaries in existing posts. They can still become primary keywords for dedicated posts.

- how early should the bride start hair and makeup (used in: post 001)
- bridal party hair and makeup schedule template (used in: post 001)
