...
export const cities: City[] = [
  ...
  },
  {
    ...
    metaDescription:
      "Bridal hair & makeup delivered to your Royse City venue — The Pearl at Sabine Creek, Castle Waterford & more. Starting at $175. Check availability today.",
    intro: [
  ...
  },
  {
    ...
    metaDescription:
      "On-location bridal hair & makeup in Forney starting at $175. We travel to The Delanie Venue, The Ritz on Buffalo Creek & more. Get a custom quote.",
    intro: [
  ...
  },
  {
    ...
    metaDescription:
      "On-location bridal hair & makeup in Heath, TX — minutes from Rockwall with minimal travel fee. Hidden Creek Events & more. Starting at $175. Book now.",
    intro: [
  ...
  },
  {
    ...
    metaDescription:
      "Getting married at The White Sparrow Barn? On-location bridal hair & makeup starting at $175. Elizabeth comes to your suite so your morning stays relaxed. Book today.",
    intro: [
  ...
  },
  {
    ...
    metaDescription:
      "On-location bridal hair & makeup for Terrell barn weddings — HR Ranch, The Establishment, Chandelier Farms & more. From $175. Check date availability.",
    intro: [
  ...
  },
  {
    ...
    metaDescription:
      "On-location bridal hair & makeup in Greenville, TX. We travel to On The Rock, Under The Wildwood & more. Starting at $175 — get your custom quote.",
    intro: [
  ...
  },
  {
    ...
    metaDescription:
      "On-location bridal hair & makeup in Sulphur Springs — The Black Oak, Country Club & more. From $175 with flat travel fee. Book your East Texas wedding today.",
    intro: [
  ...
  },
  {
    ...
    metaDescription:
      "Princeton bride? On-location hair & makeup starting at $175 — we come to Magnolia Creek Ranch, Bethsaida Ranch & your venue. Licensed since 2002. Book your date.",
    intro: [
